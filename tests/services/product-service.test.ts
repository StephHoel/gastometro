...
describe('ProductService', () => {
  ...
  it('isDuplicateItem deve considerar nome+preço normalizados e ignorar id informado', () => {
    ...
    expect(ProductService.isDuplicateItem(' arroz branco ', '10,00', products)).toBe(true)
    expect(ProductService.isDuplicateItem(' arroz branco ', '10', products, '1')).toBe(false)
    expect(ProductService.isDuplicateItem(' arroz branco ', '11', products)).toBe(false)
    expect(ProductService.isDuplicateItem('macarrão', '8', products)).toBe(false)
  })
})
